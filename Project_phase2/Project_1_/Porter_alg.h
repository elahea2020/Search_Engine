...
static char * s = (char *) malloc(i_max+1); /* a char * (=string) pointer; passed into b above */
...
static void stemfile(std::string& content, std::string& stmstr)
{
    stmstr = '\0';
    int cntr = 0;
    while(TRUE)
