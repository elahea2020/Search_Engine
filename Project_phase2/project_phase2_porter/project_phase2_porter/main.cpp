...
static void stemfile(std::string stmstr)
{
    int cntr = 0;
    while(TRUE)
    {
        int ch = stmstr[cntr++];
        if (cntr > stmstr.length())
        {
            printf("\n\n%s", s);
            return;
        }
...
//    FILE * f = fopen("/Users/codeWorm/Documents/education/Sharif University /CSE/Fundemental of programming/project_codes/Project_phase2/project_phase2_porter/Angoor.txt","r");
...
//    }
//    free(s);
    std::string s1="Tell us about an opinion you have had to defend. How has this affected your belief system";
    stemfile(s1);
    return 0;
}